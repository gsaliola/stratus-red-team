module github.com/datadog/stratus-red-team/v2/internal/attacktechniques/aws/persistence/custom-reconnaissance

go 1.21.4

require github.com/datadog/stratus-red-team/v2 v2.15.0
